...
S3Config = namedtuple("S3Config", ("bucket", "region", "acl"))
...
Note:
    ...
    AWS Access_Key and Secret_Key need to be set in your credentials file at
    ~/.aws/credentials.
""".format(
...
def get_bucket_conn(s3_config):
    ...
    s3_conn = boto.s3.connect_to_region(s3_config.region)
