...
def key_list():
    ...
    return [
        ...
        make_key("package-two/package-two-0.0.1.dev1-py2.py3-none-any.whl"),
        make_key("package-two/package-two-0.0.1.dev2-py2.py3-none-any.whl"),
        make_key("package-two/package-two-0.0.1-py2.py3-none-any.whl"),
        make_key("package-two/package_two-0.0.1.tar.gz"),
        make_key("package-two/package-two-0.0.1-py2.7.egg"),
        make_key("package-two/"),
        make_key("error-pkg/error-pkg-2.3.4-py2.py3-none-any.whl"),
        make_key("error-pkg/error-pkg-2.3.4-py2-none-any.whl"),
        make_key("error-pkg/error_pkg-2.3.4.tar.gz"),
    ]
